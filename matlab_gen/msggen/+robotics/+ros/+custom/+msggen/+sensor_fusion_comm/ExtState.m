classdef ExtState < robotics.ros.Message
    %ExtState MATLAB implementation of sensor_fusion_comm/ExtState
    ...
    properties (Constant)
        MessageType = 'sensor_fusion_comm/ExtState' % The ROS message type
    end
    ...
    methods
        function obj = ExtState(msg)
            %ExtState Construct the message object ExtState
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'ExtState', 'Header');
        ...
        function set.Pose(obj, pose)
            ...
            validateattributes(pose, {obj.GeometryMsgsPoseClass}, {'nonempty', 'scalar'}, 'ExtState', 'Pose');
        ...
        function set.Velocity(obj, velocity)
            ...
            validateattributes(velocity, {obj.GeometryMsgsVector3Class}, {'nonempty', 'scalar'}, 'ExtState', 'Velocity');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.sensor_fusion_comm.ExtState.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.sensor_fusion_comm.ExtState;
            obj.reload(strObj);
        end
    end
end
