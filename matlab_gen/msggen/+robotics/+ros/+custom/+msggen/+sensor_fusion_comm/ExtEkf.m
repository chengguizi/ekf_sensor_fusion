classdef ExtEkf < robotics.ros.Message
    %ExtEkf MATLAB implementation of sensor_fusion_comm/ExtEkf
    ...
    properties (Constant)
        MessageType = 'sensor_fusion_comm/ExtEkf' % The ROS message type
    end
    ...
    methods
        function obj = ExtEkf(msg)
            %ExtEkf Construct the message object ExtEkf
        ...
        function set.Header(obj, header)
            ...
            validateattributes(header, {obj.StdMsgsHeaderClass}, {'nonempty', 'scalar'}, 'ExtEkf', 'Header');
        ...
        function set.AngularVelocity(obj, angularvelocity)
            ...
            validateattributes(angularvelocity, {obj.GeometryMsgsVector3Class}, {'nonempty', 'scalar'}, 'ExtEkf', 'AngularVelocity');
        ...
        function set.LinearAcceleration(obj, linearacceleration)
            ...
            validateattributes(linearacceleration, {obj.GeometryMsgsVector3Class}, {'nonempty', 'scalar'}, 'ExtEkf', 'LinearAcceleration');
        ...
        function set.Flag(obj, flag)
            ...
            validateattributes(flag, {'numeric'}, {'nonempty', 'scalar'}, 'ExtEkf', 'Flag');
        ...
        function set.State(obj, state)
            ...
            validateattributes(state, {'numeric'}, {'vector'}, 'ExtEkf', 'State');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.sensor_fusion_comm.ExtEkf.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.sensor_fusion_comm.ExtEkf;
            obj.reload(strObj);
        end
    end
end
